...
export default function LoginPage() {
  ...
  // If already logged in (or login just succeeded), leave the login page
  useEffect(() => {
    if (user) {
      // change "/" to "/dashboard" if that's your main route
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    // Just call login – navigation happens in the useEffect when `user` updates
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm mt-2" style={{ color: "#B89968" }}>
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <button
            ...
            onMouseEnter={(e) =>
              !isLoading &&
              (e.currentTarget.style.backgroundColor = "#8B2A3F")
            }
            onMouseLeave={(e) =>
              !isLoading &&
              (e.currentTarget.style.backgroundColor = "#6B1F2F")
            }
          >
        ...
        >
          ...
          <div className="space-y-1 text-xs" style={{ color: "#B89968" }}>
            <p>
              <strong>manager1</strong>, <strong>sommelier1</strong>,{" "}
              <strong>expo1</strong>
            </p>
            <p>
              Password:{" "}
